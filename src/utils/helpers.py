...
def search_news(client: TavilyClient, query: str) -> Dict:
    ...
    try:
        results = client.search(
            ...
            include_domains=["moneycontrol.com", "economictimes.indiatimes.com", "reuters.com", "bloomberg.com", "business-standard.com", "financialexpress.com", "thehindu.com", "theeconomicstimes.indiatimes.com", "timesofindia.indiatimes.com", "livemint.com", "businessinsider.com", "businessinsider.in", "business-standard.com", "business-standard.in", "business-standard.com.in"]
        )
